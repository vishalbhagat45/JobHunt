      ...
      <motion.div 
        ...
        >
            <div className="text-center mb-8">
                ...
                <p className="text-gray-600">Join thousands of prefessionals finding their dream jobs</p>
            </div>
                  ...
                  <div className=" grid grid-cols-2 gap-4">
                    <button
                      ...
                      className={`p-4 rounded-lg border-2 transition-all ${
                        formData.role == 'jobseeker' ? "bg-teal-50 text-teal-700" : "border-amber-50 hover:border-amber-300"
                      }`}
                    >
                    ...
                    <button
                      ...
                      className={`p-4 rounded-lg border-2 transition-all ${
                        formData.role == 'employer' ? "bg-teal-50 text-teal-700" : "border-amber-50 hover:border-amber-300"
                      }`}
                    >
