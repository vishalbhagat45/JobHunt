      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-4 mb-4 sm:mb-0">
          <button
            ...
            className="group flex items-center space-x-2 px-2 py-2 text-sm font-medium text-gray-600 hover:text-white bg-white/50 hover:bg-gradient-to-r hover:from-teal-500 hover:to-teal-600 border border-gray-200 hover:border-transparent rounded-xl transition-all duration-300 shadow-lg shadow-gray-100 hover:shadow-xl"
          >
            <ArrowLeft className="h-4 w-4 transition-transform group-hover:-translate-x-1" />
            <span>Back</span>
          </button>

          <h1 className="text-xl md:text-2xl font-semibold tet-gray-900">Application Overview</h1>
        </div>
      </div>
    </div>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-0 pb-8">
      {Object.keys(groupedApplications).length === 0 ? (
        ...
        <div className="text-center py-16">
          ...
          <div className="mt-4 text-lg font-medium text-gray-900">No applications available</div>
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <div className="flex items-center gap-1 mt-1 text-gray-500 text-xs">
                            ...
                            <span>
                              Applied{" "} {moment(application.createdAt)?.format("Do MM YYYY")}
                            </span>
                          </div>
                        </div>
                      </div>
