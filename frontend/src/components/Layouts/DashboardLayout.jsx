...
import {Menu, Briefcase, LogOut, Building2, X} from 'lucide-react'
...
const DashboardLayout = ({activeMenu, children}) => {
    ...
    const [activeMenuItem, setActiveMenuItem] = useState(activeMenu || "dashboard")
        ...
        <div className=" flex items-center h-16 border-b border-gray-200 pl-6">
            {!sidebarCollapsed ? (
                <Link to="/" className="flex items-center space-x-3">
                    ...
                    <span className="text-gray-900 font-bold text-xl">JobHunt</span>
                </Link>
            ) : (
                <div className="h-8 w-8 bg-gradient-to-r from-teal-600 to-green-600 rounded-lg flex items-center justify-center">
